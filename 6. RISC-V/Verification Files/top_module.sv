module top_module(
    ...
    output        mem_read,  // Was internal 'MemRead'
    ...
    // Connect internal mem_write and mem_read to output port
    assign mem_write = internal_mem_write;
    assign mem_read  = ~internal_mem_write; // Assuming read when not writing
